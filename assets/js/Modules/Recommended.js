...
export default class Recommended extends Home {
			...
			<div class="container">
				<section class="main-news-section">
					<div class="viewing-user">
						<a href="/following" class="active link-to-href"> Дагаж буй </a>
						<a href="/recommended" class="link-to-href"> Санал болгож буй </a>
					</div>
				</section>
	...
	afterRender() {
		...
		// 	});
		// });
		qs("#recommended-page-renderer").addEventListener("click", (e) => {
			e.preventDefault();
			self.on("/following");
		});
		qs("#following-page-renderer").addEventListener("click", (e) => {
			e.preventDefault();
			self.on("/recommended");
		});
	}
